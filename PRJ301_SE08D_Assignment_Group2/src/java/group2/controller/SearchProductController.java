 ...
 * @author daong
 */
@WebServlet(name = "SearchDeviceController", urlPatterns = {"/SearchDeviceController"})
public class SearchProductController extends HttpServlet {

    public static final String SUCCESS = "MainController?action=redirectShop";
    public static final String ERROR = "MainController?action=redirectShop";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ProductDTO> list = pdao.searchProduct(name);
