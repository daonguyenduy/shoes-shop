<%-- 
    Document   : update
    Created on : Jul 4, 2021, 8:17:50 PM
    Author     : daong
--%>
                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <a href="MainController?action=admin" class="btn btn-success" > <span>Back to admin page</span></a>
                            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="UpdateProductController" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Image</label>
                                    <img src="images/${p.image}" width="150" height="100">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <input type="submit" class="btn btn-info" value="Save" style="background: #ea572d">
                                </div>
                            </form>
                        </div>
                    </div>
